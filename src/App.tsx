...
const SCOPE_CONFIGS: Record<ProjectScope, { name: string; icon: string; categories: string[]; defaultTitle: string }> = {
  pool: {
    name: 'Pool',
    icon: '🏊',
    categories: ['Planning', 'Pool Shell', 'Inground Spa', 'Access & Site Prep', 'Excavation', 'Plumbing', 'Electrical', 'Gas & Heating', 'Structural', 'Masonry', 'Coping & Tile', 'Decking', 'Deck Finish', 'Interior Finish', 'Cleaning System', 'Equipment & Controls', 'Water Features', 'Accessories', 'Landscaping & Misc'],
...
const DEFAULT_LINE_ITEMS: Record<ProjectScope, Record<string, LineItemTemplate[]>> = {
  pool: {
    'Planning': [
      { description: 'Pool Design / Permit Processing', unit: 'LS', margin: 20, subcontract: 2200.00, notes: 'Design and permit fees' },
      { description: 'Structural Engineering', unit: 'LS', margin: 20, subcontract: 1500.00 },
      { description: 'Survey / Stakeout', unit: 'LS', margin: 20 },
      { description: 'HOA Approval / Coordination', unit: 'LS', margin: 15 },
    ],
    'Pool Shell': [
      { description: '4,000psi Shotcrete #8 Stone', unit: 'CYD', margin: 25, materials: 362.25, notes: 'Standard pool shell' },
      { description: 'Rebar Material #4x20\'', unit: 'Bar', margin: 22, materials: 10.35 },
      { description: 'Rebar Installation', unit: 'LS', margin: 25, subcontract: 5175.00, notes: 'R. Gaeta' },
      { description: 'Plaster (Standard)', unit: 'SF', margin: 25, materials: 3.50, labor: 4.00 },
    ],
    'Inground Spa': [
      { description: 'Additional Plaster for Spa', unit: 'SF', margin: 25, materials: 3.50, labor: 4.00 },
      { description: 'Additional Shotcrete for Spa', unit: 'CYD', margin: 25, materials: 362.25 },
      { description: 'Additional Rebar for Spa', unit: 'Bar', margin: 22, materials: 10.35 },
      { description: 'Spa Blower 1.5hp', unit: 'EA', margin: 25, materials: 485.00 },
      { description: 'Spa Jets & Plumbing', unit: 'SET', margin: 25, materials: 750.00, labor: 500.00 },
    ],
    'Access & Site Prep': [
      { description: 'Gate for Access', unit: 'EA', margin: 22, materials: 350.00, labor: 150.00 },
      { description: 'Fencing (Temporary)', unit: 'LF', margin: 20, materials: 8.00, labor: 4.00 },
      { description: 'Deck Removal', unit: 'SF', margin: 22, labor: 2.50, equipment: 1.50 },
      { description: 'Tree Removal', unit: 'EA', margin: 22, labor: 350.00, equipment: 150.00 },
    ],
    'Excavation': [
      { description: 'BlueCrew Excavation w/ Labor', unit: 'LS', margin: 22, labor: 3047.50, notes: 'Standard pool excavation' },
      { description: 'Bobcat/Loader Rental', unit: 'Day', margin: 22, equipment: 350.00 },
      { description: 'Silt Fence', unit: 'LF', margin: 20, materials: 3.50, labor: 1.50 },
      { description: 'Backfill Fine Grading', unit: 'LS', margin: 22, labor: 850.00, equipment: 400.00 },
      { description: 'Spoils Removal / Haul Off', unit: 'Load', margin: 22, labor: 450.00, equipment: 250.00 },
    ],
    'Plumbing': [
      { description: 'Auto Leveler', unit: 'EA', margin: 25, materials: 285.00, labor: 150.00 },
      { description: 'Waterfall 2" Line', unit: 'EA', margin: 25, materials: 175.00, labor: 200.00 },
      { description: 'Deck Drain Line', unit: 'EA', margin: 25, materials: 125.00, labor: 175.00 },
      { description: '2" PVC Schedule 40', unit: 'LF', margin: 22, materials: 4.50 },
      { description: '1.5" PVC Schedule 40', unit: 'LF', margin: 22, materials: 3.25 },
      { description: 'Main Drain (Dual)', unit: 'SET', margin: 25, materials: 245.00, labor: 200.00 },
      { description: 'Return Inlets', unit: 'EA', margin: 25, materials: 45.00, labor: 75.00 },
      { description: 'Equipment Pad Plumbing', unit: 'LS', margin: 25, materials: 450.00, labor: 600.00 },
    ],
    'Electrical': [
      { description: 'Add Sub-Panel 60 amp', unit: 'LS', margin: 25, subcontract: 5750.00 },
      { description: 'Add Sub-Panel 100 amp', unit: 'LS', margin: 25, subcontract: 6500.00 },
      { description: 'Microbrite LED Light', unit: 'EA', margin: 28, materials: 577.83, labor: 150.00 },
      { description: 'Globrite LED Light', unit: 'EA', margin: 28, materials: 695.00, labor: 150.00 },
      { description: 'Intellibrite 5G Color LED', unit: 'EA', margin: 28, materials: 785.00, labor: 175.00 },
      { description: '300W Transformer', unit: 'EA', margin: 22, materials: 208.00, labor: 125.00 },
      { description: 'Pool/Spa Bonding', unit: 'LS', margin: 25, materials: 175.00, labor: 350.00 },
      { description: 'IntelliTouch Control System', unit: 'LS', margin: 30, materials: 2850.00, labor: 500.00, notes: 'Pentair automation' },
      { description: 'EasyTouch Control System', unit: 'LS', margin: 30, materials: 1950.00, labor: 450.00, notes: 'Pentair automation' },
    ],
    'Gas & Heating': [
      { description: 'Gas Hookup (from existing)', unit: 'LS', margin: 25, materials: 350.00, labor: 450.00 },
      { description: 'Gas Line Extension (per LF)', unit: 'LF', margin: 25, materials: 18.00, labor: 12.00 },
      { description: 'Propane Tank Installation', unit: 'LS', margin: 25, materials: 850.00, labor: 400.00 },
      { description: 'Heater Pentair MasterTemp 400 kbtu', unit: 'EA', margin: 25, materials: 4143.66, labor: 350.00 },
      { description: 'Heater Pentair MasterTemp 250 kbtu', unit: 'EA', margin: 25, materials: 3245.00, labor: 350.00 },
      { description: 'Heat Pump (Electric)', unit: 'EA', margin: 25, materials: 4850.00, labor: 450.00 },
    ],
    'Structural': [
      { description: 'Stainless Steel Handrail', unit: 'EA', margin: 28, materials: 485.00, labor: 175.00 },
      { description: 'Bond Beam', unit: 'LF', margin: 25, materials: 18.00, labor: 22.00 },
      { description: 'Swim-Out Bench', unit: 'EA', margin: 25, materials: 450.00, labor: 350.00 },
      { description: 'Tanning Ledge / Baja Shelf', unit: 'SF', margin: 25, materials: 35.00, labor: 28.00 },
      { description: 'Pool Steps (Standard)', unit: 'SET', margin: 25, materials: 650.00, labor: 400.00 },
      { description: 'Spa Spillway', unit: 'EA', margin: 28, materials: 750.00, labor: 450.00 },
    ],
    'Masonry': [
      { description: 'CMU Blocks 8x8x16', unit: 'Block', margin: 22, materials: 2.08, labor: 12.00, notes: 'Augusta Concrete Block' },
      { description: 'Concrete Steps w/ finish', unit: 'EA', margin: 25, materials: 185.00, labor: 225.00 },
      { description: 'Raised Wall Veneer', unit: 'SF', margin: 25, materials: 10.50, labor: 14.00, notes: 'Eric Salas' },
      { description: 'Bagged Concrete - Cell Fill', unit: 'Bag', margin: 22, materials: 6.00 },
      { description: 'Mortar Type N', unit: 'Bag', margin: 22, materials: 18.00 },
    ],
    'Coping & Tile': [
      { description: 'Coping 12x24x3cm Travertine', unit: 'LF', margin: 30, materials: 35.65, labor: 18.00 },
      { description: 'Coping Bullnose Paver', unit: 'LF', margin: 30, materials: 28.00, labor: 16.00 },
      { description: 'Cantilever Coping (Poured)', unit: 'LF', margin: 30, labor: 22.00, notes: 'Poured with deck' },
      { description: 'Waterline Tile (Standard 6")', unit: 'LF', margin: 30, materials: 12.00, labor: 14.00 },
      { description: 'Waterline Tile (Glass)', unit: 'LF', margin: 32, materials: 28.00, labor: 16.00 },
      { description: 'Step Marker Tiles', unit: 'SET', margin: 28, materials: 85.00, labor: 75.00 },
    ],
    'Decking': [
      { description: 'Concrete Deck smooth/broom finish', unit: 'SF', margin: 22, materials: 3.33, labor: 3.00 },
      { description: 'Concrete Pumping', unit: 'LS', margin: 22, subcontract: 850.00 },
      { description: 'Equipment Pad (Concrete)', unit: 'SF', margin: 22, materials: 8.00, labor: 6.00 },
      { description: 'Deck Expansion Joints', unit: 'LF', margin: 22, materials: 2.50, labor: 3.00 },
    ],
    'Deck Finish': [
      { description: 'Kool-Deck Classic', unit: 'SF', margin: 28, materials: 2.25, labor: 2.75 },
      { description: 'Kool-Deck Knock-Down', unit: 'SF', margin: 28, materials: 2.75, labor: 3.25 },
      { description: 'Stamped Concrete', unit: 'SF', margin: 30, materials: 3.50, labor: 4.50 },
      { description: 'Travertine Pavers', unit: 'SF', margin: 32, materials: 8.50, labor: 6.00 },
      { description: 'Exposed Aggregate', unit: 'SF', margin: 28, materials: 2.00, labor: 3.50 },
    ],
    'Interior Finish': [
      { description: 'White Plaster (Standard)', unit: 'SF', margin: 28, materials: 3.50, labor: 4.00 },
      { description: 'Blue Plaster', unit: 'SF', margin: 28, materials: 4.00, labor: 4.00 },
      { description: 'Tier3 StoneScape Pebble', unit: 'LS', margin: 30, subcontract: 12822.50, notes: 'NPP Pools' },
      { description: 'Mini Pebble (Standard)', unit: 'SF', margin: 30, materials: 6.50, labor: 5.50 },
      { description: 'Pebble Sheen', unit: 'SF', margin: 30, materials: 7.00, labor: 5.50 },
      { description: 'Quartz Finish', unit: 'SF', margin: 30, materials: 5.50, labor: 5.00 },
      { description: 'Glass Bead Finish', unit: 'SF', margin: 32, materials: 8.50, labor: 6.00 },
    ],
    'Cleaning System': [
      { description: 'Suction Cleaner Line', unit: 'EA', margin: 25, materials: 145.00, labor: 175.00 },
      { description: 'Pressure Cleaner Line', unit: 'EA', margin: 25, materials: 165.00, labor: 200.00 },
      { description: 'In-Floor Cleaning System', unit: 'Zone', margin: 28, materials: 450.00, labor: 350.00 },
      { description: 'Polaris 280 Cleaner', unit: 'EA', margin: 28, materials: 685.00 },
      { description: 'Polaris 380 Cleaner', unit: 'EA', margin: 28, materials: 845.00 },
    ],
    'Equipment & Controls': [
      { description: 'Variable Speed Pump (Pentair IntelliFlo)', unit: 'EA', margin: 28, materials: 1485.00, labor: 200.00 },
      { description: 'Variable Speed Pump (Hayward TriStar)', unit: 'EA', margin: 28, materials: 1285.00, labor: 200.00 },
      { description: 'Cartridge Filter 420 sqft', unit: 'EA', margin: 28, materials: 985.00, labor: 175.00 },
      { description: 'DE Filter 60 sqft', unit: 'EA', margin: 28, materials: 1145.00, labor: 200.00 },
      { description: 'Salt Chlorine Generator (IntelliChlor)', unit: 'EA', margin: 30, materials: 1385.00, labor: 150.00 },
      { description: 'Salt Chlorine Generator (Hayward AquaRite)', unit: 'EA', margin: 30, materials: 1185.00, labor: 150.00 },
      { description: 'Check Valves / Unions', unit: 'SET', margin: 25, materials: 125.00, labor: 75.00 },
      { description: 'Booster Pump (for Cleaner)', unit: 'EA', margin: 28, materials: 485.00, labor: 125.00 },
    ],
    'Water Features': [
      { description: 'Skimmer (Standard)', unit: 'EA', margin: 25, materials: 185.00, labor: 125.00 },
      { description: 'Skimmer (Wide Mouth)', unit: 'EA', margin: 25, materials: 245.00, labor: 125.00 },
      { description: 'Sheer Descent 12"', unit: 'EA', margin: 32, materials: 485.00, labor: 250.00 },
      { description: 'Sheer Descent 24"', unit: 'EA', margin: 32, materials: 685.00, labor: 275.00 },
      { description: 'Sheer Descent 36"', unit: 'EA', margin: 32, materials: 885.00, labor: 300.00 },
      { description: 'Deck Jets (Laminar)', unit: 'EA', margin: 30, materials: 285.00, labor: 175.00 },
      { description: 'Bubblers', unit: 'EA', margin: 30, materials: 185.00, labor: 150.00 },
      { description: 'Raised Wall w/ Waterfall', unit: 'LF', margin: 32, materials: 145.00, labor: 85.00 },
      { description: 'Grotto / Rock Waterfall', unit: 'LS', margin: 35, subcontract: 8500.00 },
    ],
    'Accessories': [
      { description: 'Fire Bowl w/ Pedestal', unit: 'EA', margin: 30, materials: 3515.43, labor: 240.00, notes: 'Eric Salas Installation' },
      { description: 'Basketball Goal', unit: 'EA', margin: 28, materials: 485.00, labor: 150.00 },
      { description: 'Volleyball Net Set', unit: 'SET', margin: 28, materials: 385.00, labor: 125.00 },
      { description: 'Salt Cell (Replacement)', unit: 'EA', margin: 25, materials: 585.00 },
      { description: 'Diving Board (6ft)', unit: 'EA', margin: 28, materials: 1250.00, labor: 350.00 },
      { description: 'Pool Slide', unit: 'EA', margin: 28, materials: 2850.00, labor: 650.00 },
      { description: 'Safety Cover (Mesh)', unit: 'SF', margin: 30, materials: 8.50, labor: 4.50 },
      { description: 'Automatic Cover', unit: 'LS', margin: 30, materials: 12500.00, labor: 2500.00 },
    ],
    'Landscaping & Misc': [
      ...
      { description: 'Pavilion (see Pavilion tab)', unit: 'LS', margin: 20, notes: 'Ref separate scope' },
      { description: 'Landscaping Allowance', unit: 'LS', margin: 20 },
      { description: 'Sod Installation', unit: 'SF', margin: 22, materials: 0.65, labor: 0.35 },
    ],
  },
  portable_spa: {
    'Spa Unit': [
